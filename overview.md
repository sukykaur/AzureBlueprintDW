...
Microsoft Azure offers a variety of reporting and analytics services that can be utilized. As a part of the data reporting tier, this solution deploys SQL Server Reporting Services (SSRS), which allows you to quickly create reports from your Azure SQL Data Warehouse. This reference architecture uses a self-signed certificate for SSL traffic. As such, SSRS query and response channels are encrypted. As a best practice, it is recommended that you use a trusted certificate authority for enhanced security. 
